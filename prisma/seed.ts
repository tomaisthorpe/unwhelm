...
import { PrismaClient, Priority, TaskType, HabitType } from "../generated/prisma/client";
...
async function main() {
  ...
  const tasks = [
    ...
    // Kitchen context
    {
      ...
      completedAt: today,
      type: TaskType.HABIT,
      habitType: HabitType.MAINTENANCE,
      streak: 5,
      frequency: 1,
      userId: user.id,
    },
